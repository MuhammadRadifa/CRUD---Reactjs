...
const Register = () => {
  ...
  const { registerInput } = State;
  const { HandlingRegisterInput, HandlingRegister } = allFunct;
  return (
    <>
      <div className="min-w-screen min-h-screen  flex items-center justify-center px-5 py-5">
        <div
          ...
          style={{ maxWidth: 1000 }}
        >
          <div className="md:flex w-full p">
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-2">
                      ...
                      <div className="flex">
                        ...
                        <input
                          onChange={HandlingRegisterInput}
